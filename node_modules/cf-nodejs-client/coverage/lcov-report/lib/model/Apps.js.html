...
<html lang="en">
<head>
    <title>Code coverage report for lib\model\Apps.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\model\Apps.js</span></h1>
    <h2>
        Statements: <span class="metric">90% <small>(54 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">100% <small>(0 / 0)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">84.62% <small>(11 / 13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">90% <small>(54 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/model/</a> &#187; Apps.js</div>
</div>
<div class="body">
 ...
 * @return {[type]}              [description]
 */
Apps.prototype.getAppByName = <span class="fstat-no" title="function not covered" >function (token_type, access_token, appName) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var url = this.API_URL + "/v2/apps";</span>
...
<span class="cstat-no" title="statement not covered" >    return this.REST.request(options, "200", true);</span>
};
&nbsp;
/**
 ...
 * @return {[type]}                     [description]
 */
Apps.prototype.checkResources = <span class="fstat-no" title="function not covered" >function(token_type,access_token,zipResources){</span>
<span class="cstat-no" title="statement not covered" >    var url = this.API_URL + "/v2/resource_match";</span>
<span class="cstat-no" title="statement not covered" >    var options = {</span>
        method: 'PUT',
        url: url,
        headers: {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.REST.request(options,"200",false); </span>
}
&nbsp;
/**
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Aug 18 2015 14:05:48 GMT+0200 (Hora de verano romance)</div>
</div>
